...
def make_meme(topString, bottomString, filename):
	...
	for x in range(-outlineRange, outlineRange+1):
		for y in range(-outlineRange, outlineRange+1):
			draw.text((topTextPosition[0]+x, topTextPosition[1]+y), topString, (10,0,0), font=font)
			draw.text((bottomTextPosition[0]+x, bottomTextPosition[1]+y), bottomString, (10,0,0), font=font)

	draw.text(topTextPosition, topString, (245,245,245), font=font)
	draw.text(bottomTextPosition, bottomString, (245,245,245), font=font)
